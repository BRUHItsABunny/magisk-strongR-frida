...
updateJson=https://github.com/BRUHItsABunny/magisk-strongR-frida/releases/latest/download/updater.json
...
def create_updater_json(project_tag: str):
    ...
    updater = {
        "version": project_tag,
        "versionCode": generate_version_code(project_tag),
        "zipUrl": f"https://github.com/BRUHItsABunny/magisk-strongR-frida/releases/download/{project_tag}/MagiskFrida-{project_tag}.zip",
        "changelog": "https://raw.githubusercontent.com/BRUHItsABunny/magisk-strongR-frida/master/CHANGELOG.md",
    }
